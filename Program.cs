...
namespace FloriculturaConsoleApp
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            var client = new MongoClient("mongodb+srv://jhonklebson11:TAoXAMkE464OQSdy@cluster0.xybwrdc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
            var database = client.GetDatabase("jhonklebson11");
